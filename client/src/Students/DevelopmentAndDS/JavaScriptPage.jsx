...
const JavaScriptPage = () => {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            {/* Sidebar of the page*/}
            <div
                className={`w-64 bg-white shadow-md fixed h-full overflow-y-auto transition-transform duration-300 ease-in-out z-40 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                    } lg:translate-x-0`}
            >
            ...
            {/* Main Content */}
            <div className="flex-1 lg:ml-64 p-4 sm:p-8 pt-20 sm:pt-36 pb-8 transition-all duration-300">
                ...
                <section id="introduction" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Introduction to JavaScript</h2>
                ...
                <section id="variable-scope" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Variable Scope in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="global-variables" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Global Variables in JavaScript</h2>
                    <div className="space-y-4">
                ...
                <section id="function-parameters" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Function Parameters in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="objects" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Objects in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="number" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Number in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="boolean" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Boolean in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="strings" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Strings in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="arrays" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Arrays in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="date" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">Date in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section id="dataview" className="mb-16 bg-white rounded-xl shadow-md p-4 sm:p-8">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800 border-b pb-2">DataView in JavaScript</h2>
                    <div className="space-y-4">
                        <p className="text-gray-700 text-sm sm:text-base">
                ...
                <section className="bg-blue-50 rounded-xl shadow-md p-4 sm:p-8 pb-12">
