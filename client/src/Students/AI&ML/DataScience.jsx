                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <ul className="space-y-1">
                                        <li><a href="https://www.coursera.org/learn/data-science" className="text-blue-600 hover:underline">Data Science on Coursera</a></li>
                                        <li><a href="https://www.datacamp.com/courses/intro-to-python-for-data-science" className="text-blue-600 hover:underline">Intro to Python for Data Science</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold mb-2">Related Tutorials</h4>
                                    <ul className="space-y-1">
                                        <li><a href="https://www.geeksforgeeks.org/python-for-data-science/" className="text-blue-600 hover:underline">Python for Data Science</a></li>
                                        <li><a href="https://www.geeksforgeeks.org/statistics-for-data-science/" className="text-blue-600 hover:underline">Statistics for Data Science</a></li>
                                    </ul>
                                </div>
                                <div>
                                    <h4 className="font-semibold mb-2">Data Science Topics</h4>
                                    <ul className="space-y-1">
                                        <li><a href="https://www.geeksforgeeks.org/maths-for-data-science/" className="text-blue-600 hover:underline">Maths for Data Science</a></li>
                                        <li><a href="https://www.geeksforgeeks.org/data-visualization/" className="text-blue-600 hover:underline">Data Visualization</a></li>
                                    </ul>
                                </div>
                                <div>
